...
const generateMarkdown = () => {
  ...
  md += "****NAME:**** Adon Mathew Joseph  \n";
  md += "****USN:**** 4JK22CS003  \n";
  md +=
    "****COMPANY:**** VisionAstraa EV Academy  \n";
  md += "****DESIGNATION:**** AI - ML FOR EV Intern  \n\n---\n\n";
...
const generatePDF = () => {
  ...
  doc
    .fontSize(12)
    .font("Helvetica-Bold")
    .text("Name: Adon Mathew Joseph", { align: "center" });
  doc.font("Helvetica-Bold").text("USN: 4JK22CS003", { align: "center" });
  doc
    .font("Helvetica-Bold")
    .text("Company: VisionAstraa EV Academy", {
      align: "center",
    });
  doc
    .font("Helvetica-Bold")
    .text("Designation: AI - ML FOR EV Intern", { align: "center" });
  doc.moveDown();
  doc
    .strokeColor("black")
    .lineWidth(1)
