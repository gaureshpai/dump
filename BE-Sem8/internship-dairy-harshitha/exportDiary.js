...
const generateMarkdown = () => {
  ...
  md += "****NAME:**** Harshitha  \n";
  md += "****USN:**** 4JK22CS017  \n";
  md += "****COMPANY:**** (UniCourt India) Mangalore Infotech Solutions Private Limited.  \n";
...
const generatePDF = () => {
  ...
  doc
    .font("Helvetica-Bold")
    .text("Company: (UniCourt India) Mangalore Infotech Solutions Private Limited.", { align: "center" });
  doc
    .font("Helvetica-Bold")
