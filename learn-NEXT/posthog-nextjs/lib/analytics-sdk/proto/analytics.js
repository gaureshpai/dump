...
$root.analytics = (function () {
  ...
  analytics.Event = (function () {
    ...
    Event.encode = function encode(message, writer) {
      ...
      if (
        message.distinctId != null &&
        Object.hasOwnProperty.call(message, "distinctId")
      )
      ...
      if (
        ...
        for (
          var keys = Object.keys(message.properties), i = 0;
          i < keys.length;
          ++i
        )
          writer
            ...
            .string(message.properties[keys[i]])
            .ldelim();
      return writer;
    };
    ...
    Event.decode = function decode(reader, length, error) {
      ...
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.analytics.Event(),
        key,
        value;
    ...
    Event.fromObject = function fromObject(object) {
      if (object instanceof $root.analytics.Event) return object;
      ...
      if (object.properties) {
        ...
        message.properties = {};
        for (
          var keys = Object.keys(object.properties), i = 0;
          i < keys.length;
          ++i
        )
